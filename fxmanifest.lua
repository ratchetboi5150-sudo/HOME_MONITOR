...
files {
    ...
    'module/scenes/*.js',
    'module/textures/*.js',
    'html/mato_tv/tv_screen.html',
    'html/mato_tv/tv_screen.js',
    'html/mato_tv/tv_screen.css',
    'html/mato_tv/interaction.html',
    'html/mato_tv/interaction.js',
    'html/mato_tv/interaction.css'
}
